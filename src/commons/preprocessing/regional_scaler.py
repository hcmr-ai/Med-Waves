...
class RegionalScaler(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None):
        ...
        if isinstance(X, np.ndarray):
            ...
            raise ValueError("RegionalScaler requires region information. Use fit_with_regions() method.")
    ...
    def transform(self, X, regions=None):
        ...
        """
        if regions is None:
            raise ValueError("RegionalScaler requires region information for transform. Use transform_with_regions() method.")
    ...
    def fit_transform(self, X, y=None):
        ...
        raise NotImplementedError("Use fit_with_regions() and transform_with_regions() for RegionalScaler")
