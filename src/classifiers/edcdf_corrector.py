    ...
    def fit(
        ...
        for var in variables:
            ...
            f_model_inv = interp1d(
                cdf_model, model_sorted, bounds_error=False, fill_value="extrapolate"
            )
            f_obs_inv = interp1d(
                cdf_obs, obs_sorted, bounds_error=False, fill_value="extrapolate"
            )
            f_model_cdf = interp1d(
                model_sorted, cdf_model, bounds_error=False, fill_value=(0, 1)
            )
