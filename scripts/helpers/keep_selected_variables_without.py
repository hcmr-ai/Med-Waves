...
input_dir = "/data2/ocean2/RAN_ML/VAL"

# Generate output directory by appending '_reduced' to the input directory's name
output_dir = output_dir = "/data2/ntsolis/without_reduced"
...
# variables_to_keep = ["VHM0", "WSPD", "VTM02", "WDIR", "VMDR"] #to k111eep directions as well
